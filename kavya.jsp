...
String QueryString3 ="SELECT * from product_table where"+
                     "packaging = '1 kit for 10 subcultures'and "+ 
...
String QueryString15 ="SELECT * from product_table where"+
...
String[] QueryArr = {QueryString1, QueryString2, QueryString3, QueryString4, QueryString5, QueryString6, 
				QueryString7, QueryString8, QueryString9, QueryString10, QueryString11, QueryString12, QueryString13, QueryString14, QueryString15};
		int qno = 8;
