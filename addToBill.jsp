...
<body>
	...
	<div class="col-lg-3">
		<h4> Products list </h4>
		<br>
		<table id="bill-tbl" class="table">							<!-- table for adding products in bill -->
			<thead>
				<tr>
					<th>S no.</th>
					<th>Name</th>
...
//  					console.log(responseText);
					...
					if ( responseText[0][0] == "none" ){
						...
						for (var i=0; i<responseText.length; i++){
							...
							resp += "<td>"+									// block for creating qty dropdown button
							"<button class=\"btn btn-outline-secondary btn-sm qty-btn\">qty.</button>"+
							"</td>";
							resp += "<td>"+									// block for creating delete button
							"<button class=\"btn btn-outline-secondary btn-sm add-btn\">add</button>"+
							"</td>";
							resp+="</tr>";
						}
						resp+= "</tbody></table>";
		...
		function createTbl(){
			$('#main-tbl').DataTable({
				...
				"searching": false,
				"columnDefs": [
			        { "targets": [1, 2, 3, 6, 7, 8, 9], "orderable": false}
			    ]
			}).draw(true);
		}
	});
