...
<body>
	...
	<%
		...
		connection = DriverManager.getConnection(connectionURL, "root", "root@123");	// defining connection parameters, ...getConnection(connection string, username, password)
		...
		String QueryString = "SELECT * from product_table where material_no = 'RM013-500G'";
